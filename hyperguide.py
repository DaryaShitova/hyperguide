...
class Hyper_Parameter_Provenance(widgets.DOMWidget):
    ...
    def class_knn(self, run):
        if self.current_algo == 'class_knn_def':
            ...
            n_neighbors=abs(self.current_hp_box.children[0].children[0].children[0].children[1].value)
            ...
            leaf_size=abs(self.current_hp_box.children[0].children[1].children[1].children[1].value)
            p=abs(self.current_hp_box.children[0].children[0].children[2].children[1].value)
    ...
    def reg_rf(self, run):
        if self.current_algo == 'reg_rf_def':
            ...
            n_estimators = abs(self.current_hp_box.children[0].children[0].children[0].children[1].value)
            criterion = self.current_hp_box.children[0].children[1].children[0].children[1].value
            try:
                max_depth=abs(int(self.current_hp_box.children[0].children[0].children[1].children[1].value))
            except ValueError:
                max_depth=None

            if abs(self.current_hp_box.children[0].children[0].children[2].children[1].value) <= 1:
                min_samples_split = abs(float(self.current_hp_box.children[0].children[0].children[2].children[1].value))
            elif abs(self.current_hp_box.children[0].children[0].children[2].children[1].value) > 1:
                min_samples_split = abs(int(self.current_hp_box.children[0].children[0].children[2].children[1].value))

            if abs(self.current_hp_box.children[0].children[1].children[1].children[1].value) <= 0.5:
                min_samples_leaf = abs(float(self.current_hp_box.children[0].children[1].children[1].children[1].value))
            else:
                min_samples_leaf = abs(int(self.current_hp_box.children[0].children[1].children[1].children[1].value))
            min_weight_fraction_leaf = self.current_hp_box.children[0].children[0].children[3].children[1].value
            try:
                max_features = abs(float(self.current_hp_box.children[0].children[1].children[2].children[1].value))
            except ValueError:
            ...
            try:
                ...
                max_leaf_nodes = None
            min_impurity_decrease=abs(self.current_hp_box.children[0].children[1].children[3].children[1].value)
            ...
            verbose=abs(self.current_hp_box.children[0].children[1].children[5].children[1].value)
            warm_start=self.current_hp_box.children[0].children[0].children[7].children[1].value
            ccp_alpha=abs(self.current_hp_box.children[0].children[1].children[6].children[1].value)
            try:
                max_samples=abs(float(self.current_hp_box.children[0].children[0].children[8].children[1].value))
            except ValueError:
                max_samples = None
            try:
                random_state = abs(int(self.current_hp_box.children[0].children[1].children[7].children[1].value))
            except:
                random_state = None
    ...
    def class_rf(self, run):
        if self.current_algo == 'class_rf_def':
            ...
            if abs(self.current_hp_box.children[0].children[1].children[1].children[1].value) <= 1:
                min_samples_split = abs(float(self.current_hp_box.children[0].children[1].children[1].children[1].value))
            elif abs(self.current_hp_box.children[0].children[1].children[1].children[1].value) > 1:
                min_samples_split = abs(int(self.current_hp_box.children[0].children[1].children[1].children[1].value))

            if abs(self.current_hp_box.children[0].children[0].children[2].children[1].value) <= 0.5:
                min_samples_leaf = abs(float(self.current_hp_box.children[0].children[0].children[2].children[1].value))
            else:
                min_samples_leaf = abs(int(self.current_hp_box.children[0].children[0].children[2].children[1].value))

            min_weight_fraction_leaf = self.current_hp_box.children[0].children[1].children[2].children[1].value
            try:
                max_features = abs(float(self.current_hp_box.children[0].children[0].children[3].children[1].value))
            except ValueError:
            ...
            try:
                max_leaf_nodes = abs(int(self.current_hp_box.children[0].children[1].children[3].children[1].value))
            except ValueError:
                max_leaf_nodes = None
            min_impurity_decrease = abs(self.current_hp_box.children[0].children[0].children[4].children[1].value)
            ...
            verbose=abs(self.current_hp_box.children[0].children[0].children[6].children[1].value)
            ...
            ccp_alpha=abs(self.current_hp_box.children[0].children[1].children[7].children[1].value)
            try:
                max_samples=abs(float(self.current_hp_box.children[0].children[0].children[8].children[1].value))
            except ValueError:
                max_samples = None
            try:
                random_state = abs(int(self.current_hp_box.children[0].children[1].children[8].children[1].value))
            except:
                random_state = None
    ...
    def class_svm(self, run):
        if self.current_algo == 'class_svm_def':
            ...
            c = abs(self.current_hp_box.children[0].children[0].children[0].children[1].value)
            kernel = self.current_hp_box.children[0].children[1].children[0].children[1].value
            degree = abs(self.current_hp_box.children[0].children[0].children[1].children[1].value)
            try:
                gamma = abs(float(self.current_hp_box.children[0].children[0].children[2].children[1].value))
            except:
            ...
            tol = abs(self.current_hp_box.children[0].children[1].children[2].children[1].value)
            cache_size = abs(self.current_hp_box.children[0].children[0].children[5].children[1].value)
            ...
            try:
                random_state = abs(int(self.current_hp_box.children[0].children[1].children[6].children[1].value))
            except:
                random_state = None
    ...
    def reg_log(self, run):
        if self.current_algo == 'reg_log_def':
            ...
            tol=abs(self.current_hp_box.children[0].children[1].children[1].children[1].value)
            c=abs(self.current_hp_box.children[0].children[1].children[2].children[1].value)
            ...
            try:
                random_state = abs(int(self.current_hp_box.children[0].children[1].children[4].children[1].value))
            except ValueError:
                random_state = None
            solver=self.current_hp_box.children[0].children[0].children[3].children[1].value
            max_iter=abs(self.current_hp_box.children[0].children[1].children[5].children[1].value)
